...
export class DashboardComponent {
  ...
  CargarEstudiantes() {
    this.http
      .get<any[]>('https://ucvbotbackend.onrender.com/api/students')
      .subscribe({
        next: (response) => {
  ...
  subirPregunta() {
    if (!this.preguntaTitulo) {
      this.mensaje =
        'Completa todos los campos y selecciona nivel & alternativa correcta.';
      return;
    }

    this.http
      .post('https://ucvbotbackend.onrender.com/api/InsertarPregunta', {
